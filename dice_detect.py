...
detection_folder = os.path.join(main_directory, "1_Detection")
data = os.path.join(main_directory, "Data")
...
def detect_dice():
    ...
    while True:
        ...
        if iterations_for_dice_number[len(iterations_for_dice_number) - 2] == number_of_dice_per_iteration:
            ...
            continue
    return number_of_dice_per_iteration
...
# def return_value():
#     # x = iterations_for_dice_number[len(iterations_for_dice_number)-1]
#     x = number_of_dice_per_iteration
#     return x
